<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0 0px 0 0","listStyle":"none","margin":"0","position":"relative","background":"#FFF"}' class="el-menu-vertical-demo" default-active="0">
				<el-image v-if="false" :style='{"width":"44px","margin":"10px auto","objectFit":"cover","borderRadius":"100%","display":"block","height":"44px"}' fit="cover"></el-image>
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","margin":"0 0 10px","display":"none"}
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo .el-submenu {
						padding: 0;
						margin: 0 0 10px 0;
						border-image: url(http://codegen.caihongy.cn/20220719/8d94455256c0487c9a910e12c102b93a.png) 0 35 round;
