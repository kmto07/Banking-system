<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"flex-end","background":"#6abceb","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"flex-end"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"0 0 20px","boxShadow":"0px 0px 0px 50px rgba(255,255,255,0.3000)","margin":"0","borderColor":"rgba(221,242,242,1)","borderRadius":"30px 0 0 0","background":"#fff","borderWidth":"30px 0 0 30px","width":"1500px","borderStyle":"solid","height":"800px"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"padding":"40px 0","margin":"0 0 30px 0","color":"#000","borderRadius":"0 0 30px 30px","textAlign":"center","background":"#6abceb","width":"100%","lineHeight":"1","fontSize":"20px","fontWeight":"bold"}' class="title">银行账户管理系统注册</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='yinxing'">
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='yinxing'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">银行名称</div>
					<el-input  v-model="ruleForm.yinxingmingcheng"  autocomplete="off" placeholder="银行名称"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='yinxing'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">负责人</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='yinxing'">
                    ...
                    <el-select v-model="ruleForm.xingbie" placeholder="请选择性别" >
                        <el-option
                            v-for="(item,index) in yinxingxingbieOptions"
                            v-bind:key="index"
                            :label="item"
                            :value="item">
                        </el-option>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='yinxing'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">咨询电话</div>
					<el-input  v-model="ruleForm.zixundianhua"  autocomplete="off" placeholder="咨询电话"  type="text"  />
				</el-form-item>
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"0 0 0px rgba(64, 158, 255, .5)","margin":"20px auto 5px","color":"#fff","display":"block","outline":"none","borderRadius":"5px","background":"#6abceb","width":"80%","fontSize":"18px","height":"44px"}' type="button" class="r-btn" @click="login()">注册</button>
...
export default {
	...
	mounted(){
        ...
        this.yinxingxingbieOptions = "男,女".split(',')
	},
	created() {
	...
	methods: {
		...
		login() {
			var url=this.tableName+"/register";
					...
					if((!this.ruleForm.zhanghao) && `yinxing` == this.tableName){
					...
					if((!this.ruleForm.mima) && `yinxing` == this.tableName){
						this.$message.error(`密码不能为空`);
						return
					}
					...
					if(`yinxing` == this.tableName && this.ruleForm.zixundianhua&&(!this.$validate.isMobile(this.ruleForm.zixundianhua))){
						this.$message.error(`咨询电话应输入手机格式`);
						return
					}
